...
function EducationCard({ edu, index }: { edu: EducationItem; index: number }) {
  ...
  return (
    ...
    >
      ...
      <div className="bg-surface border-hairline hover:border-hairline-strong h-full rounded-xl border p-6 transition-all duration-300 ease-out hover:scale-[1.05] sm:p-8">
